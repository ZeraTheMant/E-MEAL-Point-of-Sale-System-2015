...
namespace WindowsFormsApplication1 {
    ...
    public partial class DBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TRANSACTIONDataTable : global::System.Data.TypedTableBase<TRANSACTIONRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public TRANSACTIONRow AddTRANSACTIONRow(int ID, string DATE, decimal TOTAL, string PRODUCT) {
        ...
        public partial class TRANSACTIONRow : global::System.Data.DataRow {
            ...
            public string PRODUCT {
                get {
                    try {
                        return ((string)(this[this.tableTRANSACTION.PRODUCTColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                ...
                set {
                    this[this.tableTRANSACTION.PRODUCTColumn] = value;
                }
            }
            ...
            public bool IsPRODUCTNull() {
                return this.IsNull(this.tableTRANSACTION.PRODUCTColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetPRODUCTNull() {
                this[this.tableTRANSACTION.PRODUCTColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace WindowsFormsApplication1.DBDataSet1TableAdapters {
    ...
    public partial class TRANSACTIONTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[TRANSACTION] WHERE (([ID] = @Original_ID) AND ((@IsNull_DATE = 1 AND [DATE] IS NULL) OR ([DATE] = @Original_DATE)) AND ((@IsNull_TOTAL = 1 AND [TOTAL] IS NULL) OR ([TOTAL] = @Original_TOTAL)) AND ((@IsNull_PRODUCT = 1 AND [PRODUCT] IS NULL) OR ([PRODUCT] = @Original_PRODUCT)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TRANSACTION] ([ID], [DATE], [TOTAL], [PRODUCT]) VALUES (@ID, @" +
                "DATE, @TOTAL, @PRODUCT);\r\nSELECT ID, DATE, TOTAL, PRODUCT FROM [TRANSACTION] WHE" +
                "RE (ID = @ID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TRANSACTION] SET [ID] = @ID, [DATE] = @DATE, [TOTAL] = @TOTAL, [PRODUCT] = @PRODUCT WHERE (([ID] = @Original_ID) AND ((@IsNull_DATE = 1 AND [DATE] IS NULL) OR ([DATE] = @Original_DATE)) AND ((@IsNull_TOTAL = 1 AND [TOTAL] IS NULL) OR ([TOTAL] = @Original_TOTAL)) AND ((@IsNull_PRODUCT = 1 AND [PRODUCT] IS NULL) OR ([PRODUCT] = @Original_PRODUCT)));
SELECT ID, DATE, TOTAL, PRODUCT FROM [TRANSACTION] WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, DATE, TOTAL, PRODUCT FROM dbo.[TRANSACTION]";
        ...
        public virtual int Fill(DBDataSet1.TRANSACTIONDataTable dataTable) {
        ...
        public virtual DBDataSet1.TRANSACTIONDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DBDataSet1.TRANSACTIONDataTable dataTable = new DBDataSet1.TRANSACTIONDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DBDataSet1.TRANSACTIONDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_DATE, global::System.Nullable<decimal> Original_TOTAL, string Original_PRODUCT) {
        ...
        public virtual int Insert(int ID, string DATE, global::System.Nullable<decimal> TOTAL, string PRODUCT) {
        ...
        public virtual int Update(int ID, string DATE, global::System.Nullable<decimal> TOTAL, string PRODUCT, int Original_ID, string Original_DATE, global::System.Nullable<decimal> Original_TOTAL, string Original_PRODUCT) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string DATE, global::System.Nullable<decimal> TOTAL, string PRODUCT, int Original_ID, string Original_DATE, global::System.Nullable<decimal> Original_TOTAL, string Original_PRODUCT) {
            return this.Update(Original_ID, DATE, TOTAL, PRODUCT, Original_ID, Original_DATE, Original_TOTAL, Original_PRODUCT);
        }
    }
